...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const navigation = [
    ...
    { name: "Market Mode Order", href: "/market-mode-order", icon: ShoppingBag },
  ...
  const filteredNavigation =
    userPages.includes("all")
      ...
      : navigation.filter((item) => {
          ...
          if (navName === "market mode order" && (userPages.includes("market mode order") || userPages.includes("market_mode_order") || userPages.includes("market mode") || userPages.includes("marketmode") || userPages.includes("market_mode"))) return true;
