          ...
          <nav className="flex px-6 space-x-8" aria-label="Tabs">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span>Pending ({groupedPendingData.length})</span>
              </div>
            </button>
            <button
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span>History ({groupedHistoryData.length})</span>
              </div>
            </button>
          </nav>
        </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredData.map((item) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900 break-words min-w-[250px]">
